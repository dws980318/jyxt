    ...
    <div class="dataTable">
      ...
      <div class="dataTable_main">
        ...
        >
          ...
          <el-table-column prop="number" label="申请单位" show-overflow-tooltip></el-table-column>
          <el-table-column prop="proposer" label="活动名称" show-overflow-tooltip></el-table-column>
          <el-table-column prop="type" label="项目类别" show-overflow-tooltip></el-table-column>
          <el-table-column prop="id" label="申请信息" width="120" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
              <router-link :to="'/student/protocol/three/unchecked/' + scope.row.id">
