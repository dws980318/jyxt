<template>
  <el-col :span="24">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="待审核" name="/company/enter/unchecked"></el-tab-pane>
      <el-tab-pane label="已审核" name="/company/enter/checked"></el-tab-pane>
    </el-tabs>
...
export default {
  ...
  data () {
    return {
      loading: false,
      activeName: '/rcompany/enter/unchecked',
      historyActive: '/rcompany/enter/unchecked'
    }
  },
  created () {
