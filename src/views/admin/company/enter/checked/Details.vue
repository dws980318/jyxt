    ...
    <div class="information">
      <div class="form">
        ...
        <el-form :model="information" label-width="120px" ref="ruleForm" class="demo-ruleForm">
          ...
          <el-form-item label="入驻情况：" prop="open">
            <el-switch v-model="information.open" active-color="#13ce66" inactive-color="#999"></el-switch>
          </el-form-item>
        </el-form>
      </div>
      <div class="form">
        <div class="el-notification__title form_title">注册信息</div>
      ...
      <div class="form">
        <div class="el-notification__title form_title">发票信息</div>
