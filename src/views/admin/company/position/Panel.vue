<template>
  <el-col :span="24">
    <!-- <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="待审核" name="/company/position/unchecked"></el-tab-pane>
      <el-tab-pane label="已审核" name="/company/position/checked"></el-tab-pane>
    </el-tabs> -->
...
export default {
  ...
  data () {
    return {
      loading: false,
      activeName: '/company/position/unchecked',
      historyActive: '/company/position/unchecked'
    }
  },
  created () {
