  ...
  <el-col :span="24">
    <div class="dataTable">
      <div class="dataTable_header">
        <el-col :span="8">
          <el-button type="success" size="mini" @click="toAdd()">新增见面会</el-button>
      ...
      <div class="dataTable_main">
        <el-table ref="multipleTable" v-loading="loading" :data="list" :header-row-style="headerStyle" tooltip-effect="dark" size="small" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="view" label="阅读" width="50" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column prop="apply" label="报名" width="50" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column prop="sort" label="排序" width="50" align="center" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toAdd () {
      this.$router.push('/recruiting/jobFair/info/add')
    },
    toPass () {
    ...
    handleEdit (index, studentId) {
      ...
      this.$router.push('/recruiting/jobFair/info/' + studentId)
    },
