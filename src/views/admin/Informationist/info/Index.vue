  ...
  <el-col :span="24">
    <div style="padding:20px 0 29px 0;" class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item to="/Informationist/info/list">
咨询师信息管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="dataTable">
      ...
      <div class="dataTable_main">
        ...
        >
          ...
          <el-table-column prop="type" label="工号" width="200" show-overflow-tooltip></el-table-column>
          <el-table-column prop="account" label="咨询师姓名" width="200" show-overflow-tooltip></el-table-column>
          <el-table-column prop="power" label="教师职务" width="200"></el-table-column>
          <el-table-column prop="one" label="擅长领域" width="200"></el-table-column>
          ...
          <el-table-column prop="name" label="个人资料" width="140" show-overflow-tooltip>
            <template slot-scope="scope">
              <router-link :to="'/Informationist/info/' + scope.row.id">
