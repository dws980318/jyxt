    ...
    <div class="dataTable">
      ...
      <div class="dataTable_main">
        ...
        >
          ...
          <el-table-column prop="type" label="学号" width="200" show-overflow-tooltip></el-table-column>
          <el-table-column prop="account" label="学生姓名" width="200" show-overflow-tooltip></el-table-column>
          <el-table-column prop="power" label="咨询师" width="200"></el-table-column>
          <el-table-column prop="one" label="预约时间段" width="200"></el-table-column>
          <el-table-column prop="phone" label="预约内容" width="200">
            <template slot-scope>
              <p style="color:dodgerblue;cursor:pointer" @click="address = true">查看</p>
            </template>
          </el-table-column>
          <el-table-column prop="name" label="咨询师资料" width="140" show-overflow-tooltip>
            <template slot-scope="scope">
              <router-link :to="'/Informationist/position/unchecked/' + scope.row.id">
                <p style="color:dodgerblue;cursor:pointer">详情</p>
              </router-link>
            </template>
          </el-table-column>
          <el-table-column prop="phone" label="预约状态" width="auto"></el-table-column>
        </el-table>
      </div>
