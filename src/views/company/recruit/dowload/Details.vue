      ...
      <div class="form">
        ...
        <el-form :model="position" label-width="100px" ref="ruleForm" class="demo-ruleForm">
          <el-form-item label="邀请状态：" prop="checked">
            <el-button size="mini" type="success" @click="handleEdit(scope.$index, scope.row.id)">邀请面试</el-button>
            <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">拒绝面试</el-button>
          </el-form-item>
        </el-form>
      </div>
      <div class="form">
