<template>
  <div id="complaint">
    <div class="complaint-heared">
      <div>
        <div class="line">
          <i class="el-icon-warning"></i>查看曾经下载的简历。
        </div>
      </div>
    </div>
    <div class="complaint bg border">
      ...
      <div class="complaint-content">
        ...
        >
          ...
          <el-table-column prop="name" align="center" label="职位信息" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="sr_name" label="工作性质" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="checked" label="显示状态" show-overflow-tooltip>
          ...
          <el-table-column align="center" prop="open" label="学校审核信息" show-overflow-tooltip>
            <template slot-scope="scope">
              <p
          ...
          <el-table-column align="center" prop="sr_nme" label="统计信息" show-overflow-tooltip></el-table-column>
          <el-table-column align="center" prop="sr_me" label="状态" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  //查询所有收到的学生简历列表
    ...
    handleDelete(index, row) {
      let resumeDelivery = { sr_id: row.id };
      this.api.deleResumeDeliveryBySrId(resumeDelivery).then(res => {
        console.log(res);
        if (res.code === 200) {
